...
Express based RESTful API for starter applications. Based on the Yo RESTful API generator, with an updated authentication routine and without the babel transpiler. 
